...
public abstract class Doc
{
	...
	public void setPeriod()
	{
		...
		//	Is Period Open?
		if (getPO().get_TableName().equals(MJournal.Table_Name))
		{
			String PostingType = getPO().get_ValueAsString("PostingType");
			if (PostingType.equals("B") || PostingType.equals("E")
					|| PostingType.equals("R") ||PostingType.equals("S"))
			{
	...
	//SHW
	public static final int 	ACCTTYPE_e_prepayment_acct = 200;
	...
	public int getValidCombination_ID (int AcctType, MAcctSchema as)
	{
		...
		else if (AcctType == ACCTTYPE_e_prepayment_acct)
		{
			sql = "SELECT  e_prepayment_acct FROM c_bp_employee_acct WHERE C_BPartner_ID=? AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
		}
